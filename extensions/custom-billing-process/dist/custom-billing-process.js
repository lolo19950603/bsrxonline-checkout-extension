...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [patientIds, setPatientIds] = (0, import_react19.useState)({});
    ...
    (0, import_react19.useEffect)(() => {
        ...
        if (line.attributes) {
          for (let j = 0; j < line.attributes.length; j++) {
            ...
            if (attribute.key === "tag") {
              ...
              if (line.merchandise.product.productType === "needs PM approval") {
      ...
      applyAttributeChange({
        key: "Needs PM Approval",
        type: "updateAttribute",
        value: needsPmApproval
      });
    }, []);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      (hasInfusionClinicOrHomePharma || isPssChecked) && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        ...
        isOkToShowIcnHomePharmaBanner && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "tight" }) }),
    ...
    function handlePatientIdInputChange(program, value) {
      return __async(this, null, function* () {
        setPatientIds((prevIds) => __spreadProps(__spreadValues({}, prevIds), {
          [program]: value
        }));
        yield applyAttributeChange({
